...
export function JobConsult(props) {
  ...
  const getIdleClientCount = async () => {
    try {
      const response = await fetch(`http://43.203.200.170/api/api/client/IDLE?size=10000`, {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = () => {
    ...
    fetch(`http://43.203.200.170/api/api/command/${clientOperationCount}`, {
      method: "POST",
                ...
                <div className="flex flex-col">
                  ...
                  <div className=" mb-2">
                    ...
                    <Button className="ml-2 p-2" onClick={() => {
                      setRequestDomain('https://i.imgur.com/scYOVJF.png')
                    }}>
                      붙여넣기
                    </Button>
                  </div>
                  <div className=" mb-2">
                    <span>우리광고</span>
                    <Button className="ml-2 p-2" onClick={() => {
                      setRequestDomain('https://i.imgur.com/ozFWmwc.png')
                    }}>
                      붙여넣기
                    </Button>
                  </div>
